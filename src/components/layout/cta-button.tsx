...
const CTAButton = ({
  ...
  bgColorHex = 'var(--primary)',
  arrowBgColorBefore = 'var(--foreground)',
  arrowTravelDistance = 'calc(100% + 9.8rem)',
  textShift = -30,
  duration = 0.3,
  className = '',
  textColorBefore = 'currentColor',
  textColorAfter = 'var(--primary-foreground)',
  iconColorBefore = 'var(--background)',
  iconColorAfter = 'var(--primary-foreground)',
}: CTAButtonProps) => {
  return (
