...
function TabsIndicator({
  ...
  return (
    <BaseUITabs.Indicator
      ...
      className={cn(
        "absolute left-0 z-0 h-[calc(100%-6px)] w-[var(--active-tab-width)] translate-x-[var(--active-tab-left)] rounded-md bg-background shadow-sm transition-all duration-200 ease-in-out dark:bg-input/30",
        className
      )}
      {...props}
    />
